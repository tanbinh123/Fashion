...
<!-- Mirrored from codingeek.net/html/roberto-ferracini/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jan 2020 14:36:49 GMT -->
...
<head>
    ...
    <!-- Datepicker -->
    <link rel="stylesheet" href='<c:url value="/resources/web/css/datepicker.min.css"/>'>
    <!-- Main Stylesheet -->
...
<!-- Banner Starts -->
<section class="under-construction-banner">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
