...
<!-- Mirrored from codingeek.net/html/roberto-ferracini/profile-notifications.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jan 2020 14:37:59 GMT -->
...
<body class="profile-page profile-notifications common-typography">
                            ...
                            <div class="form-border">
                                ...
                                <div class="social-links d-flex justify-content-between">
                                    <div class="single-link">
                                        <h6>Discounts And Sales</h6>
                                        <p>Be first in line to nab the stuff you love for less.</p>
                                    </div>
                                    <div class="switch-button align-self-end">
                                        <label class="switch">
                                            <input type="checkbox">
                                ...
                                <div class="social-links d-flex justify-content-between">
                                    <div class="single-link">
                                        <h6>New Stuff</h6>
                                        <p>Fashion drops, news and style advice: Hear it first, wear it first.</p>
                                    </div>
                                    <div class="switch-button align-self-end">
                                        <label class="switch">
                                            <input type="checkbox">
                                ...
                                <div class="social-links d-flex justify-content-between">
                                    <div class="single-link">
                                        <h6>Your Exclusives</h6>
                                        <p>Enjoy a birthday treat, as well as tailored rewards and account updates.</p>
                                    </div>
                                    <div class="switch-button align-self-end">
                                        <label class="switch">
                                            <input type="checkbox">
                                ...
                                <div class="social-links d-flex justify-content-between">
                                    <div class="single-link">
                                        ...
                                        <p>If that product you’re into comes back in stock, get a heads-up so You can add to bag pronto</p>
                                    </div>
                                    <div class="switch-button align-self-end">
                                        <label class="switch">
                                            <input type="checkbox">
                                ...
                                <div class="form-button">
                                    ...
                                    <button type="button" class="template-btn2 on1">Save Changes<span class="custom-icon"></span></button>
                                </div>
                            </div>
                        </div>
                    </div>
