              ...
              <form class="user">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="exampleFirstName" placeholder="First Name">
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" name="exampleLastName" placeholder="Last Name">
                  </div>
                </div>
                ...
                <a href="#"class="btn btn-primary btn-user btn-block btn-register">
                  Register Account
                </a>
                <hr>
